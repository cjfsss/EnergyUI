...
public class AppBar extends Toolbar {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        menuLp.leftMargin = (int) a.getDimension(R.styleable.AppBar_menuLeftMargin, dp2px(6));
        menuLp.rightMargin = (int) a.getDimension(R.styleable.AppBar_menuRightMargin, dp2px(12));
        ...
        final int[] textSizeResIds = {R.styleable.AppBar_menu1TextSize,
                R.styleable.AppBar_menu2TextSize, R.styleable.AppBar_menu3TextSize,
                R.styleable.AppBar_menu4TextSize, R.styleable.AppBar_menu5TextSize};
        final int[] colorResIds = {R.styleable.AppBar_menu1Color,
                R.styleable.AppBar_menu2Color, R.styleable.AppBar_menu3Color,
                R.styleable.AppBar_menu4Color, R.styleable.AppBar_menu5Color};
