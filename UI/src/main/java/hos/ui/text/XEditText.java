...
public class XEditText extends RegexEditText {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (hasFocused && mBitmap != null && isPwdInputType && !isTextEmpty()) {
            int left = (int) (getMeasuredWidth() - getPaddingRight() -
                                   mTogglePwdDrawable.getIntrinsicWidth() - mBitmap.getWidth() - ViewUtils.dp2px(this,4));
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (hasFocused && isPwdInputType && event.getAction() == MotionEvent.ACTION_UP) {
            ...
            if (!disableClear) {
                right -= w + ViewUtils.dp2px(this,4);
