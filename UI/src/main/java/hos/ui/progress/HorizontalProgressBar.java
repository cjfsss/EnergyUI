...
public class HorizontalProgressBar extends View {
    ...
    public HorizontalProgressBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        final int progressColor = typedArray.getColor(R.styleable.HorizontalProgressBar_horizontalProgressColor, 0xFFf66b12);
        final int bgColor = typedArray.getColor(R.styleable.HorizontalProgressBar_horizontalProgressBgColor, 0xFFe1e5e8);
        final int textPaintSize = typedArray.getDimensionPixelOffset(R.styleable.HorizontalProgressBar_horizontalProgressTextSize, sp2px(10));
        typedArray.recycle();
        init();
