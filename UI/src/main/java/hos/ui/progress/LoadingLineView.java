...
public class LoadingLineView extends View {
    ...
    private boolean mLoadingLineStart = false;
    ...
    private void getAtt(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.LoadingLineView);

        mViewHeight = typedArray.getDimensionPixelOffset(R.styleable.LoadingLineView_loadingLineBgHeight, dp2px(2));
        final int loadingLineColor = typedArray.getColor(R.styleable.LoadingLineView_loadingLineColor, 0xFFf66b12);
        final int loadingLineBgColor = typedArray.getColor(R.styleable.LoadingLineView_loadingLineBgColor, 0xFFe1e5e8);
        mLoadingLineStart = typedArray.getBoolean(R.styleable.LoadingLineView_loadingLineStart, false);

        typedArray.recycle();

        bgPaint = getPaint(mViewHeight, loadingLineBgColor, Paint.Style.FILL);
        loadingPaint = getPaint(mViewHeight, loadingLineColor, Paint.Style.FILL);
    }


    public void setLoadingColor(int loadingLineColor) {
        loadingPaint = getPaint(mViewHeight, loadingLineColor, Paint.Style.FILL);
    }
